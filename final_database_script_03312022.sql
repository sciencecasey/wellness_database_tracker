...
-- -----------------------------------------------------
-- Table `new_schema1`.`SEX_AT_BIRTH_LOOKUP`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `new_schema1`.`SEX_AT_BIRTH_LOOKUP` (
...
-- -----------------------------------------------------
-- Table `new_schema1`.`COUNTRY_LOOKUP_TABLE`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `new_schema1`.`COUNTRY_LOOKUP_TABLE` (
...
-- -----------------------------------------------------
-- Table `new_schema1`.`STATE_LOOKUP`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `new_schema1`.`STATE_LOOKUP` (
  ...
  CONSTRAINT `fk_STATE_IN_COUNTRY_COUNTRY_LOOKUP_TABLE1`
    ...
    REFERENCES `new_schema1`.`COUNTRY_LOOKUP_TABLE` (`country_abbreviation`)
    ON DELETE RESTRICT
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `new_schema1`.`USER` (
  ...
  `SEX_AT_BIRTH_LOOKUP_sex_abbreviation` VARCHAR(1) NOT NULL COMMENT 'Sex at birth',
  ...
  INDEX `fk_USER_SEX_AT_BIRTH_LOOKUP1_idx` (`SEX_AT_BIRTH_LOOKUP_sex_abbreviation` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_USER_SEX_AT_BIRTH_LOOKUP1`
    FOREIGN KEY (`SEX_AT_BIRTH_LOOKUP_sex_abbreviation`)
    REFERENCES `new_schema1`.`SEX_AT_BIRTH_LOOKUP` (`sex_abbreviation`)
    ON DELETE RESTRICT
    ON UPDATE CASCADE,
  CONSTRAINT `fk_USER_STATE_IN_COUNTRY1`
    ...
    REFERENCES `new_schema1`.`STATE_LOOKUP` (`COUNTRY_LOOKUP_TABLE_country_abbreviation` , `state_abbreviation`)
    ON DELETE RESTRICT
    ON UPDATE CASCADE)
ENGINE = InnoDB
PACK_KEYS = Default
...
-- -----------------------------------------------------
-- Table `new_schema1`.`FEMALE_LOOKUP`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `new_schema1`.`FEMALE_LOOKUP` (
...
CREATE TABLE IF NOT EXISTS `new_schema1`.`FEMALE_INSTANCE` (
  ...
  CONSTRAINT `fk_FEMALE_INSTANCE_FEMALE_CYCLES1`
    ...
    REFERENCES `new_schema1`.`FEMALE_LOOKUP` (`type_name`)
    ON DELETE RESTRICT
    ON UPDATE CASCADE)
ENGINE = InnoDB
PACK_KEYS = Default;
...
-- -----------------------------------------------------
-- Table `new_schema1`.`CHRONICITY_LOOKUP`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `new_schema1`.`CHRONICITY_LOOKUP` (
...
CREATE TABLE IF NOT EXISTS `new_schema1`.`CONDITION_TYPE` (
  ...
  CONSTRAINT `fk_CONDITION_TYPE_CHRONICITY_LOOKUP1`
    ...
    REFERENCES `new_schema1`.`CHRONICITY_LOOKUP` (`type`)
    ON DELETE RESTRICT
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `new_schema1`.`CONDITION_INSTANCE` (
  ...
  CONSTRAINT `fk_CONDITION_INSTANCE_CONDITION_TYPE1`
    ...
    REFERENCES `new_schema1`.`CONDITION_TYPE` (`condition_id`)
    ON DELETE RESTRICT
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `new_schema1`.`CONDITION_SYMPTOM` (
  ...
  CONSTRAINT `fk_CONDITION_SYMPTOM_CONDITION_INSTANCE1`
    ...
    REFERENCES `new_schema1`.`CONDITION_INSTANCE` (`condition_instance_id`)
    ON DELETE RESTRICT
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `new_schema1`.`MOOD_INSTANCE` (
  ...
  CONSTRAINT `fk_MOOD_INSTANCE_MOOD_TYPE1`
    ...
    REFERENCES `new_schema1`.`MOOD_TYPE` (`id`)
    ON DELETE RESTRICT
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `new_schema1`.`POSITIONS_LOOKUP`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `new_schema1`.`POSITIONS_LOOKUP` (
...
-- -----------------------------------------------------
-- Table `new_schema1`.`TOOL_LOOKUP`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `new_schema1`.`TOOL_LOOKUP` (
...
CREATE TABLE IF NOT EXISTS `new_schema1`.`VITALS_TYPE` (
  ...
  CONSTRAINT `fk_VITALS_TYPE_POSITIONS_LOOKUP1`
    ...
    REFERENCES `new_schema1`.`POSITIONS_LOOKUP` (`positions_latin_name`)
    ON DELETE RESTRICT
    ON UPDATE CASCADE,
  CONSTRAINT `fk_VITALS_TYPE_TOOL_LOOKUP1`
    FOREIGN KEY (`TOOL_LOOKUP_toolname`)
    REFERENCES `new_schema1`.`TOOL_LOOKUP` (`toolname`)
    ON DELETE RESTRICT
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `new_schema1`.`VITAL_INSTANCE` (
  ...
  CONSTRAINT `fk_VITAL_INSTANCE_VITALS_TYPE1`
    ...
    REFERENCES `new_schema1`.`VITALS_TYPE` (`vital_code`)
    ON DELETE RESTRICT
    ON UPDATE CASCADE,
...
CREATE TABLE IF NOT EXISTS `new_schema1`.`SLEEP_INSTANCE` (
  ...
  CONSTRAINT `fk_SLEEP_INSTANCE_SLEEP_LOCATIONS1`
    ...
    REFERENCES `new_schema1`.`LOCATIONS` (`location_id`)
    ON DELETE RESTRICT
    ON UPDATE CASCADE,
...
CREATE TABLE IF NOT EXISTS `new_schema1`.`INTOXICANT_INSTANCE` (
  ...
  CONSTRAINT `fk_INTOXICANT_INSTANCE_RECREATIONAL_INTOXICANT1`
    ...
    REFERENCES `new_schema1`.`RECREATIONAL_INTOXICANT` (`intoxicant_id`)
    ON DELETE RESTRICT
    ON UPDATE CASCADE,
